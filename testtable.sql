...
--
-- Хост: 127.0.0.1
-- Время создания: Сен 05 2023 г., 10:47
...
(903, 'hello!', 114, 105, 'warning', 'images/usr3.png', 'mr.Bean', 'марк', '2023-09-05 08:46:04');
...
(105, 'ofline', 'Bqm0Y_0w2v0ezLsxAAAL', 'марк'),
(106, 'ofline', 'zmVopt2QKjLSNTz4AAAF', 'carmen'),
(114, 'ofline', 'xSdsyIVRQkzoRZUZAAAH', 'mr.Bean'),
...
--
ALTER TABLE `messages`
  MODIFY `id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=905;
